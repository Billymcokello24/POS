    ...
    public function initiate(Request $request)
    {
        ...
        try {
            ...
            SubscriptionPayment::create([
                ...
                'raw_response' => is_array($result['response']) ? $result['response'] : null,
            ]);
        ...
        return response()->json(['success' => true, 'data' => ['checkout_request_id' => $result['checkout_request_id'] ?? null, 'merchant_request_id' => $result['merchant_request_id'] ?? null]]);
    }
}
