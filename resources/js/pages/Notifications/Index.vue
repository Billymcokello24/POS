...
<template>
    ...
    <AppLayout>
        <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-6">
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-slate-600 mt-1">Stay updated with your business activities</p>
                    </div>
                    <Button
                        v-if="unreadCount > 0"
                        @click="markAllAsRead"
                ...
                <div class="grid grid-cols-3 gap-4">
                    <Card>
                        <CardContent class="pt-6">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-blue-600">{{ notifications?.meta?.total || notifications.data.length }}</div>
                    ...
                    <Card>
                        <CardContent class="pt-6">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-green-600">{{ (notifications?.meta?.total || notifications.data.length) - unreadCount }}</div>
